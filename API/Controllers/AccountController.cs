    ...
    ) : BaseApiController
{
    ...
    public async Task<ActionResult> LoginWithGitHubAsync(string code)
    {
        ...
        if (user == null) return BadRequest("Failed to read the user from GitHub");
    ...
    [AllowAnonymous]
    [HttpPost("register")]
    public async Task<ActionResult> RegisterUserAsync(RegisterDto registerDto)
    {
        var user = new User()
        {
    ...
    public async Task<ActionResult> ResendEmailConfirmationAsync(string? email, string? userId)
    {
