...
export default function RegisterSuccess({email}: Props) {
    ...
    return (
        ...
        >
            ...
            <Typography gutterBottom variant="h3"> You have successfully registered!</Typography>
            <Typography gutterBottom variant="h3"> Please check your email to confirm you account</Typography>
